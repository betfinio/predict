...
const BonusInfo: FC<{ game: Game }> = ({ game }) => {
	...
	return (
		<div className={'h-full'}>
			<div className={'bg-background-light rounded-md p-2 lg:p-4 flex flex-col relative  justify-between gap-2 lg:gap-4 '}>
							...
							<div className={'text-xs text-muted-foreground italic'}>
								<div className={'text-center'}>
									<Trans
										...
										i18n={i18n}
										components={{ b: <b className={'text-secondary-foreground font-medium'} /> }}
									/>
								</div>
